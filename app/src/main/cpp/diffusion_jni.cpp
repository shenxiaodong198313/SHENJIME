...
Java_com_shenji_aikeyboard_mnn_llm_DiffusionSession_resetNative(JNIEnv *env, jobject thiz,
                                                                 jlong instance_id) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_shenji_aikeyboard_mnn_llm_DiffusionSession_releaseNative(JNIEnv *env, jobject thiz,
                               jlong instance_id) {
...
Java_com_shenji_aikeyboard_mnn_llm_DiffusionSession_initNative(JNIEnv *env,
                                                                jobject thiz,
                                                                jstring config_path,
...
Java_com_shenji_aikeyboard_mnn_llm_DiffusionSession_submitDiffusionNative(JNIEnv *env,
                                                                           jobject thiz,
                                                                           jlong instance_id,
                                                                           jstring input,
