...
JNIEXPORT jlong JNICALL Java_com_shenji_aikeyboard_mnn_llm_LlmSession_initNative(JNIEnv *env,
                                                                                  jobject thiz,
                                                                                  jstring modelDir,
...
JNIEXPORT jobject JNICALL Java_com_shenji_aikeyboard_mnn_llm_LlmSession_submitNative(JNIEnv *env,
                                                                                      jobject thiz,
                                                                                      jlong llmPtr,
                                                                                      jstring inputStr,
...
Java_com_shenji_aikeyboard_mnn_llm_LlmSession_resetNative(JNIEnv *env, jobject thiz,
                                                           jlong object_ptr) {
...
Java_com_shenji_aikeyboard_mnn_llm_LlmSession_setWavformCallbackNative(
...
Java_com_shenji_aikeyboard_mnn_llm_LlmSession_getDebugInfoNative(JNIEnv *env, jobject thiz,
                                                                  jlong objecPtr) {
...
JNIEXPORT void JNICALL Java_com_shenji_aikeyboard_mnn_llm_LlmSession_releaseNative(JNIEnv *env,
                                                                                    jobject thiz,
                                                                                    jlong objecPtr) {
    MNN_DEBUG("Java_com_shenji_aikeyboard_mnn_llm_LlmSession_releaseNative\n");
    auto *llm = reinterpret_cast<mls::LlmSession *>(objecPtr);
    delete llm;
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_shenji_aikeyboard_mnn_llm_LlmSession_updateMaxNewTokensNative(JNIEnv *env, jobject thiz,
                                                                        jlong llm_ptr,
                                                                        jint max_new_tokens) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_shenji_aikeyboard_mnn_llm_LlmSession_updateSystemPromptNative(JNIEnv *env, jobject thiz,
                                                                        jlong llm_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_shenji_aikeyboard_mnn_llm_LlmSession_updateAssistantPromptNative(JNIEnv *env,
                                                                           jobject thiz,
                                                                           jlong llm_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_shenji_aikeyboard_mnn_llm_LlmSession_updateEnableAudioOutputNative(JNIEnv *env,jobject thiz, jlong llm_ptr, jboolean enable) {
    auto *llm = reinterpret_cast<mls::LlmSession *>(llm_ptr);
    if (llm) {
