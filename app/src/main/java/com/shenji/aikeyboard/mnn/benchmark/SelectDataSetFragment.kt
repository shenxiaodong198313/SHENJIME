...
package com.shenji.aikeyboard.mnn.benchmark
...
import com.shenji.aikeyboard.databinding.FragmentChooseDatasetBinding
...
class SelectDataSetFragment:BottomSheetDialogFragment() {
    ...
    private fun loadOptionsData() {
        val sampleOptions = listOf(
            ...
            OptionItem(id = "mmlu", title = "MMLU 文本数据集", subtitle = "包含文本数据约100条"),
